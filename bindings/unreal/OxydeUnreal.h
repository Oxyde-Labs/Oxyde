...
public:
     ...
     */
    static bool GetAgentEmotionVector(const char* AgentId, float* OutJoy, float* OutAnger, float* OutFear);
...
private:
    ...
    typedef bool (*GetEmotionVectorFuncPtr)(const char*, float*, float*, float*);
